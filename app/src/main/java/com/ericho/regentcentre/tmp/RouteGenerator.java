...
public class RouteGenerator {
    public static List<RouteObject> getTodayList(Calendar calendar,@Location String fromLoc){
        switch (calendar.get(Calendar.DAY_OF_WEEK)){
            ...
            case 6:
                return getWeekDayRouteList(fromLoc);
            case 7:
                return getWeekEndRouteList(fromLoc);
            default:
                return new ArrayList<>();
        }
    }
    public static List<RouteObject> getWeekDayRouteList(@Location String fromLocation) {
        List<RouteObject> res = new ArrayList<>();

        //start from regent centre
        if(Location.centre.equals(fromLocation)) {
        ...
        //start MTR station
        if(Location.mtrPoint.equals(fromLocation)) {
    ...
    public static List<RouteObject> getWeekEndRouteList(@Location String fromLocation) {
        List<RouteObject> res = new ArrayList<>();
